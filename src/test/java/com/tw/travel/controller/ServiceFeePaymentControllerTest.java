...
@ActiveProfiles("test")
public class ServiceFeePaymentControllerTest {

    @TestConfiguration
    public static class Config {
        @MockBean
        ServiceFeePaymentService serviceFeePaymentService;
    }

    @Autowired
    private ServiceFeePaymentService serviceFeePaymentService;
